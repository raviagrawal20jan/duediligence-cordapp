...
function LoginLexisNexis(props) {
const [showLogin, setLogin] = useState(false);
 ...
 const submit = () => {
        ...
        localStorage.setItem("llogin", true);

    }


if(localStorage.getItem("llogin")=='false'){
  return (


    <div className="App login-bg-l">
...
export default LoginLexisNexis;
