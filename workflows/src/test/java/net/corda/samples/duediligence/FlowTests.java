...
public class FlowTests {
    ...
    public void CreationAndSigningTheAuditingRequest() throws ExecutionException, InterruptedException {
        RequestToValidateCorporateRecords.RequestToValidateCorporateRecordsInitiator flow1 =
                new RequestToValidateCorporateRecords.RequestToValidateCorporateRecordsInitiator(b.getInfo().getLegalIdentities().get(0),10, "test name", "test address","test phone", "test income", "test make","test model","test style");
