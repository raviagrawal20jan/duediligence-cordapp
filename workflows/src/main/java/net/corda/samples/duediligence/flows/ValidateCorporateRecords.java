...
public class ValidateCorporateRecords {
    ...
    public static class ValidateCorporateRecordsInitiator extends FlowLogic<SignedTransaction> {
        ...
        public SignedTransaction call() throws FlowException {
            ...
            //Creating the output
            CorporateRecordsAuditRequest output = new CorporateRecordsAuditRequest(input.getApplicant(),getOurIdentity(),input.getNumberOfFiles(), input.getName(), input.getAddress(), input.getPhoneNbr(), input.getIncome(), input.getVehicleMake(), input.getVehicleModel(), input.getVehicleStyle(),input.getLinearId());
